...
def join_app(function=None, data_flow_kernel=None, cache=False, executors='all', ignore_for_cache=None, join=False):
    return python_app(function=function, data_flow_kernel=data_flow_kernel, cache=cache, ignore_for_cache=ignore_for_cache, join=True, executors=["_parsl_internal"])
